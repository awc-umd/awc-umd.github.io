...
document.addEventListener('DOMContentLoaded', () => {
    ...
    for (let i = 1; i <= count; i++) {
        ...
        li.innerHTML = `<img src="${folder}image${i}.png" alt="Page ${i}" loading="lazy">`;
        ul.appendChild(li);
    }
    new Splide('#gallery-2025', { type: 'loop', perPage: 4, focus: 'center', gap: '1rem', padding: '1rem' }).mount();
});

document.addEventListener('DOMContentLoaded', () => {
    const folder = 'assets/images/gallery-sponsor/';
...
document.addEventListener('DOMContentLoaded', () => {
    const folder = 'assets/images/posters/';
